...
class DotaxCrawling():
    ...
    searchUrl =  "http://cafe984.daum.net/_c21_/cafesearch?grpid=mEr9&fldid=&pagenum=" + str(pageNum) + "&listnum=20&item=subject&head=&query="+ keyword + "&attachfile_yn=&media_info=&viewtype=all&searchPeriod=" + now + "-" + now + "&sorttype=0&nickname="
    ...
    def GetSearchCount(self, keyword):
        self.SettingSession()
        self.searchUrl =  "http://cafe984.daum.net/_c21_/cafesearch?grpid=mEr9&fldid=&pagenum=&listnum=20&item=subject&head=&query="+ keyword + "&attachfile_yn=&media_info=&viewtype=all&searchPeriod=" + self.now + "-" + self.now + "&sorttype=0&nickname="
        response = self.session.get(self.searchUrl)
    ...
    def GetPeriodCount(self, keyword):
        ...
        for period in self.month_list:
            periodUrl = "http://cafe984.daum.net/_c21_/cafesearch?grpid=mEr9&fldid=&pagenum=&listnum=20&item=subject&head=&query=" + keyword + "&attachfile_yn=&media_info=&viewtype=all&searchPeriod=" + period + "-" + period + "&sorttype=0&nickname="
